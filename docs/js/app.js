(() => {
    ...
    function initSliders() {
        if (document.querySelector(".section-04__slider")) var swiper = new Swiper(".section-04__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".section-04__slider .swiper-button-prev",
                nextEl: ".section-04__slider .swiper-button-next"
            },
            on: {
                init: function() {
                ...
                slideChange: function() {
                    ...
                    var sectionBody = this.el.closest(".section-body");
    ...
    class FullPage {
        ...
        setEvents() {
            ...
            const nextArrowBtns = document.querySelectorAll(".btn-click-nxt");
        ...
        touchMove(e) {
            ...
            if (this.goScroll && Math.abs(yCoord) > 45) this.choiceOfDirection(yCoord);
        }
        touchUp(e) {
